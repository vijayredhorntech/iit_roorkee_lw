   ...
   <div wire:loading.class="opacity-25">
       ...
       <div class="w-full border-[1px] border-t-[4px] border-primary/20 border-t-primary bg-white flex gap-2 flex-col mt-4 mb-4 ">
           ...
           <div class="p-4">
               ...
               <div class="w-full flex justify-end gap-2 items-center mb-4">
                   ...
                   <table class="w-full border-[2px] border-secondary/40 border-collapse mt-4">
                       ...
                       @forelse($bookings as $booking)
                           <tr class="hover:bg-secondary/10 cursor-pointer transition ease-in duration-2000">
                               ...
                               <td class="border-[2px] border-secondary/40 px-4 py-1.5 text-ternary/80 font-medium text-sm">{{$booking->instrument->per_hour_cost * (Carbon\Carbon::parse($booking->slot->end_time)->diffInMinutes(Carbon\Carbon::parse($booking->slot->start_time)) / 60)}} </td>
                           </tr>
                       @empty
                           <tr>
